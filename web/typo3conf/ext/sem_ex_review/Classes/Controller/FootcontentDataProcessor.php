...
class FootcontentDataProcessor extends AbstractDataProcessor
{
    /**
    ...
    public function process(
        ...
        $processedData['footcontents'] = $this->objectManager->get(RowRepository::class)->findByUid($cObj->data['uid'])
                                                                                        ->getFootcontent();      
