CREATE TABLE tt_content (
    ...
    tx_semexcontent_footcontents  int(11)  DEFAULT '0' NOT NULL,
    tx_semexcontent_ordercontents int(11)  DEFAULT '0' NOT NULL
);
...
CREATE TABLE tx_semexcontent_domain_model_footcontent (
    uid              int(11)      NOT NULL auto_increment,
    pid              int(11)      DEFAULT '0' NOT NULL,
    tstamp           int(11)      DEFAULT '0' NOT NULL,
    crdate           int(11)      DEFAULT '0' NOT NULL,
    ...
    second_phone     varchar(30)  DEFAULT ''  NOT NULL,
    email            varchar(100) DEFAULT ''  NOT NULL,
    copyright        varchar(250) DEFAULT ''  NOT NULL,
    footcontent      int(11)      DEFAULT '0' NOT NULL,

    PRIMARY KEY (uid),
    KEY parent (pid),
    KEY sys_language_uid_l10n_parent (sys_language_uid,l10n_parent),
    KEY footcontent (footcontent)
);

CREATE TABLE tx_semexcontent_domain_model_ordercontent (
    uid              int(11)      NOT NULL auto_increment,
    pid              int(11)      DEFAULT '0' NOT NULL,
    tstamp           int(11)      DEFAULT '0' NOT NULL,
    crdate           int(11)      DEFAULT '0' NOT NULL,
    ...
    header           varchar(250) DEFAULT ''  NOT NULL,
    name             varchar(250) DEFAULT ''  NOT NULL,
    phone            varchar(100) DEFAULT ''  NOT NULL,
    email            varchar(30)  DEFAULT ''  NOT NULL,
    wish             mediumtext,
    send             varchar(250) DEFAULT ''  NOT NULL,
    quantity         varchar(250) DEFAULT ''  NOT NULL,
    ordercontent     int(11)      DEFAULT '0' NOT NULL,

    PRIMARY KEY (uid),
    KEY parent (pid),
    KEY sys_language_uid_l10n_parent (sys_language_uid,l10n_parent),
    KEY ordercontent (ordercontent)
);

CREATE TABLE tx_semexcontent_domain_model_order (
    uid              int(11)      NOT NULL auto_increment,
    pid              int(11)      DEFAULT '0' NOT NULL,
    tstamp           int(11)      DEFAULT '0' NOT NULL,
    crdate           int(11)      DEFAULT '0' NOT NULL,
